...
def main():
    ...
    latitudes[:] = np.linspace(
        src_trans[3] + src_trans[5] / 2 + src_trans[4],
        src_trans[3] + y * src_trans[5] - src_trans[5] / 2,
        y,
    )
    longitudes[:] = np.linspace(
        src_trans[0] + src_trans[1] / 2 + src_trans[2],
        src_trans[0] + x * src_trans[1] - src_trans[1] / 2,
        x,
    )
    for y in range(100):
