...
if __name__ == "__main__":
  ...
  assert r1 == r2.args[1], 'expected trees to be equal %s != %s' % (repr(r1),
                                                                    repr(r2.args[1]))
  ...
  models = robjects.r('models <- readRDS("out/_d5ed9724c6cb2c78b59707f69b3044e6/cropland.rds")')
